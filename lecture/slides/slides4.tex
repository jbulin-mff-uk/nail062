...
\begin{frame}{Čtvrtá přednáška}
    ...
    \textbf{Program}
        \begin{itemize}            
            ...
            \item úvod do rezoluce
            %\item hilbertovský kalkulus
        \end{itemize}

    \textbf{Materiály}

        \href{https://github.com/jbulin-mff-uk/nail062/raw/main/lecture/lecture-notes/lecture-notes.pdf}{\alert{\textbf{Zápisky z přednášky}}}, Sekce 4.3-4.7 z Kapitoly 4 (Sekci 4.8 zatím přeskočíme), Sekce 5.1 z Kapitoly 5
