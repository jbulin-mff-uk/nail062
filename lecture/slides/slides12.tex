...
\begin{frame}{Rekurzivně spočetná kompletace}
    ...
    \pause
    \myblock{
        $T$ má \alert{rekurzivně spočetnou kompletaci}, je-li (nějaká) množina až na $\sim$ všech kompletních jednoduchých extenzí $T$ spočetná, a \alert{rekurzivně spočetná}, tj. existuje algoritmus, který pro vstup $(i,j)$ vypíše $i$-tý axiom $j$-té extenze (v nějakém uspořádání), nebo odpoví, že už neexistuje.
    }
