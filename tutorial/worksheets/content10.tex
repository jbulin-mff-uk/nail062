    ...
    \begin{solution}
        ...
        \begin{enumerate}[(a)]
            ...
            \begin{center}            
                ...
                \end{forest}
            \end{center}
            \item Yes, in (c) we managed to construct an LI-refutation. Even if we had not, the existence of an LI-refutation can be seen from the completeness theorem of LI-resolution for Horn formulas; while our CNF formula $S$ is not Horn, it would become Horn if we replaced $C$ by its negation (i.e., formalized ``sheep is uncloned'').
        \end{enumerate}
