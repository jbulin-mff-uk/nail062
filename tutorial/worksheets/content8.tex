                          ...
                          [\T M(c_0)
                            [\T M(c_1)
                              [\textcolor{blue}{\T(\forall x)(\forall y)(M(x)\wedge M(y)\to M(x+y))}
                                [\T(\forall x)(\forall y)(M(x)\wedge M(y)\to M(x+y))
                            ...
                            [{\T(\forall y)c_1=y}
                              [{\T c_1=c_0}
                                [\textcolor{blue}{\T(\forall x_1)(\forall x_2)(\forall y_1)(\forall y_2)(x_1=y_1\wedge x_2=y_2\to (x_1=x_2\to y_1=y_2))}
                                  [{\T(\forall x_1)(\forall x_2)(\forall y_1)(\forall y_2)(x_1=y_1\wedge x_2=y_2\to (x_1=x_2\to y_1=y_2))}
