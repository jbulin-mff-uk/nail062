...
\begin{example}
    Spočtěme rezoluční uzávěr formule $S$ z Příkladu \ref{example:resolution-proof}. Klauzule z $S$ jsou \textcolor{blue}{modře}, další klauzule získáváme postupným rezolvováním (první s první, druhá s první, druhá s druhou atd., přes všechny možné literály):
    \begin{align*}
