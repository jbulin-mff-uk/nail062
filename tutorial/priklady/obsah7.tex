...
\begin{problem}
    ...
    \begin{solution}
        ...
        \begin{enumerate}[(a)]
            ...
            \item Ne, jakkoliv bychom interpretovali funkční symbol $-$ jako funkci $f:\mathbb Q\to\mathbb Q$, axiom $x+(-x)=0$ by vyžadoval, aby pro každé $q\in\mathbb Q$ platilo $q\cdot f(q)=1$, což nelze kvůli $q=0$.
