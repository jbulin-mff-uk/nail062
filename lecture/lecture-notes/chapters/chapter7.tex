...
$$
\Thm_\mathbb L(T)=\{\varphi\mid \varphi\text{ je $L$-sentence a } T\proves\varphi\}
$$
...
\begin{itemize}
    ...
    \item Teorie je \emph{kompletní}, jestliže pro každou sentenci $\varphi$ je buď $T\proves\varphi$ nebo $T\not\proves\varphi$ (ale ne obojí, jinak by byla sporná).
    \item Věta o dedukci: Pro teorii $T$ a sentence $\varphi,\psi$ platí:
    $T,\varphi\proves\psi$ právě když $T\proves\varphi\to\psi$.
\end{itemize}
...
K této větě se ještě vrátíme v Kapitole \ref{chapter:model-theory}, kde si ukážeme silnější verzi zahrnující i jazyky s rovností (v nich je \emph{kanonický model }). 

Stejně jako ve výrokové logice platí Věta o kompaktnosti:
