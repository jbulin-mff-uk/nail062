...
Je-li $P$ položka v nejlevějším vrcholu $v$ na co nejmenší úrovni tabla $\tau_i$, která není redukovaná na nějaké bezesporné větvi procházející $P$ (resp. jde-li o položky typu `všichni', její \emph{výskyt} v tomto vrcholu není redukovaný)  definujeme:
\begin{itemize}
