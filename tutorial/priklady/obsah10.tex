    ...
    \begin{solution}
        ...
        \begin{enumerate}[(a)]
            ...
            \begin{center}            
                ...
                \end{forest}
            \end{center}
            \item Ano, v (c) se nám podařilo sestrojit LI-zamítnutí. I kdyby ne, existenci LI-zamítnutí lze nahlédnout z Věty o úplnosti LI-rezoluce pro Hornovy formule: naše CNF formule $S$ sice není Hornova, ale byla by Hornova pokud bychom zaměnili $K$ za jeho negaci (tj. formalizovali ``ovce je nenaklonovaná'').
        \end{enumerate}
