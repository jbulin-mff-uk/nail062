...
\begin{itemize}
    ...
    %$\varphi$ je \mdef{dokazatelná} v $T$, má-li důkaz z $T$. Značíme $T \proves_{H} \varphi$, popř. $\proves_H \varphi$ pro $T=\emptyset$.
    \medskip
    ...
    Je-li $T=\emptyset$, značíme $\proves_H \varphi$. Např. pro \mygreen{$T=\{\neg \varphi\}$} je \mygreen{$T \proves_H \varphi \to \psi$} pro každé $\psi$.
    ...
    \vspace{-4mm}
    {\bf \myblue{Věta}}\ \ {\it  Pro každou teorii $T$ a formuli $\varphi$,\ \ $T\proves_H \varphi\ \Rightarrow\ T\models \varphi$.}
    \smallskip
...
%     \end{itemize}
%     If such a proof exists, we write $T\ \proves_H\ \varphi$.