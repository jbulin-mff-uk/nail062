...
$$
Obdobně pro binární logické spojky, jsou-li $\varphi,\psi$ formule a $\lbinsymb\in\{\landsymb,\lorsymb,\limpliessymb,\liffsymb\}$, potom:
$$
...
\begin{definition}[Definovatelné množiny]
    ...
    $$
Zkráceně totéž zapíšeme také jako $\varphi^\A(\bar x)=\{\bar a\in A^n\mid\A\models\varphi[e(\bar x/\bar a)]\}$. Množina $R\subseteq A^n$ je \emph{definovatelná ve struktuře $\A$}, pokud existuje formule $\varphi(\bar x)$ taková, že $R=\varphi^\A(\bar x)$.
\end{definition}
