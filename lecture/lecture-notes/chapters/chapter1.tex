...
\begin{itemize}
    ...
    \item ``Existuje vrchol výstupního stupně 1'': \( (\exists x)(\forall y)(\forall z)((E(x,y) \land E(x,z)) \limplies y=z) \) 
\end{itemize}
