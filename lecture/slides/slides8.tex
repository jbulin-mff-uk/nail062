...
\begin{frame}{Osmá přednáška}
    ...
    \textbf{Program}
        \begin{itemize}
            ...
            \item korektnost a úplnost tablo metody, kanonický model
    ...
    \textbf{Materiály}
        ...
        \href{https://github.com/jbulin-mff-uk/nail062/raw/main/lecture/lecture-notes/lecture-notes.pdf}{\alert{\textbf{Zápisky z přednášky}}}, Sekce 7.3-7.6 z Kapitoly 7 (+ Sekce 4.8)
...
\begin{frame}{Axiomy rovnosti}
    ...
    \begin{enumerate}[(i)]
        \item $x=x$\pause
        \item pro každý $n$-ární (nekonstantní) funkční symbol $f$ jazyka $L$:
        $$
